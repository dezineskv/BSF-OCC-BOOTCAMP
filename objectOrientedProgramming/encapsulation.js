...
/* encapsulation. use uppercase first letter of the object/class
 add properties/params account#, bal
 after properties create method, can accept a param amount
 withdrawal needs an extra param so need a if statement */
